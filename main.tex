...
\input{content/02-chapter-1}

\chapter{Проектная часть}
\input{content/03-chapter-2}
...
\makeappendicesblock
\appendixchapterfirst{А}{Исходный код конечного автомата тестовой сессии}
\input{content/05-appendix-a}
\appendixchapternext{Б}{Конфигурация GoReleaser}
\input{content/06-appendix-b}
\appendixchapternext{В}{Интеграционные тесты движка нагрузочного тестирования}
\input{content/07-appendix-c}
\appendixchapternext{Г}{Пример JSON-отчёта результатов нагрузочного теста}
\input{content/08-appendix-d}
